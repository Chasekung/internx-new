-- Safe version of fix_ambiguous_form_id.sql
...
EXCEPTION WHEN others THEN
    RAISE NOTICE 'Error dropping function is_form_accepting_responses: %', SQLERRM;
END $$;
...
EXCEPTION WHEN others THEN
    RAISE NOTICE 'Error creating function is_form_accepting_responses: %', SQLERRM;
END $$;

-- Update the validate_form_submission function to be more robust
DO $$
BEGIN
    ...
    $func$ LANGUAGE plpgsql;
EXCEPTION WHEN others THEN
    RAISE NOTICE 'Error creating function validate_form_submission: %', SQLERRM;
END $$; 