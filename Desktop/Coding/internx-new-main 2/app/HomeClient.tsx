...
export default function HomeClient() {
  ...
  // Add smooth scroll function for Learn More button
  const scrollToFeatures = () => {
    const featuresSection = document.querySelector('.py-8.sm\\:py-12.bg-gray-50');
    if (featuresSection) {
    ...
    <div className="relative">
      ...
      <div className="bg-white py-12 sm:py-24">
        <div className="mobile-container">
          ...
          {/* Feature Section */}
          <div className="py-8 sm:py-12 bg-gradient-to-b from-gray-50 via-sky-50/30 to-gray-50">
            <div className="mobile-container">
              ...
              <div className="mt-8 sm:mt-10">
                <div className="mobile-responsive-spacing md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="h-full flex flex-col space-y-4 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 rounded-xl p-6 shadow-lg hover:shadow-2xl border border-sky-200/50 hover:border-sky-300 transition-all duration-300 group-hover:scale-105 backdrop-blur-sm">
                        <div className="text-center">
                  ...
                  >
                    {testimonials.map((testimonial, index) => (
                      <div key={index} className="w-[300px] sm:w-[400px] px-2">
                        <div className="mobile-card h-[280px] flex flex-col bg-white rounded-lg p-6 shadow-lg border border-gray-200">
                          <div className="flex items-center">
                            <img
