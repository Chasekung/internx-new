...
const features = [
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 shadow-lg">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-start">
            <div>
                <h3 className="text-xl font-semibold text-blue-900">AI Interview Practice</h3>
                <p className="text-indigo-600 font-medium">Session in Progress</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/70 rounded-lg p-3 text-center">
              ...
              <p className="text-blue-700 font-bold">3/5 Questions</p>
            </div>
            <div className="bg-white/70 rounded-lg p-3 text-center">
              <p className="text-sm text-gray-600 font-medium">Score</p>
              <p className="text-indigo-600 font-bold text-lg">85%</p>
            </div>
          </div>
        </div>
      </div>
    ...
    mockup: (
      <div className="bg-gradient-to-br from-purple-50 to-pink-100 rounded-2xl p-6 shadow-lg">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-start">
            <div>
                <h3 className="text-xl font-semibold text-purple-900">Performance Analytics</h3>
                <p className="text-pink-600 font-medium">Monthly Report</p>
            </div>
    ...
    mockup: (
      <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 shadow-lg">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-xl font-semibold text-green-900">TechFlow Studios</h3>
              <p className="text-emerald-600 font-medium">Marketing Intern</p>
            </div>
            <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">
              For-Profit
            </span>
  ...
  },
  {
    ...
    mockup: (
      <div className="bg-gradient-to-br from-orange-50 to-red-100 rounded-2xl p-6 shadow-lg">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-start">
            <div>
                <h3 className="text-xl font-semibold text-orange-900">TechFlow Studios</h3>
                <p className="text-red-600 font-medium">Marketing Intern</p>
            </div>
            <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">
              Active
            </span>
...
export default function HomeClient() {
  ...
  return (
    <div className="relative">
      {/* Hero Section */}
      <div className="relative pt-20 sm:pt-32 pb-32 sm:pb-64 overflow-hidden bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
        ...
        <div className="absolute inset-0 overflow-hidden z-0">
          <motion.div
            ...
            className="absolute -top-40 -right-40 w-[40rem] h-[40rem] bg-blue-100 rounded-full mix-blend-multiply filter blur-xl animate-blob"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.4 }}
            transition={{ duration: 1.5, delay: 0.2, ease: "easeOut" }}
            className="absolute -bottom-40 -left-40 w-[44rem] h-[44rem] bg-blue-200 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.4 }}
            transition={{ duration: 1.5, delay: 0.4, ease: "easeOut" }}
            className="absolute top-40 left-40 w-[42rem] h-[42rem] bg-blue-100 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
            transition={{ duration: 1.5, delay: 0.6, ease: "easeOut" }}
            className="absolute top-20 right-20 w-[38rem] h-[38rem] bg-indigo-100 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-6000"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
            transition={{ duration: 1.5, delay: 0.8, ease: "easeOut" }}
            className="absolute bottom-20 right-20 w-[36rem] h-[36rem] bg-purple-100 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-8000"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
            transition={{ duration: 1.5, delay: 1.0, ease: "easeOut" }}
            className="absolute top-60 left-60 w-[34rem] h-[34rem] bg-blue-200 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-10000"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.3 }}
            transition={{ duration: 1.5, delay: 1.2, ease: "easeOut" }}
            className="absolute -top-20 left-20 w-[32rem] h-[32rem] bg-indigo-200 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-12000"
          />
        </div>
        ...
        >
          <div className="text-center">
            ...
            >
             ...
             >
               AI-powered platform connecting high school students with meaningful opportunities.
             </motion.p>
            <motion.div
              variants={itemVariants}
              ...
              <div className="mobile-flex gap-3 sm:gap-4">
                ...
                <div className="mt-3 sm:mt-0">
                  <button
                    ...
                    className="mobile-button bg-blue-100 text-blue-700 hover:bg-blue-200 transition-all duration-300 hover:scale-105 cursor-pointer"
                  >
                    Learn More
                  </button>
                </div>
          ...
          <div id="features" className="py-8 sm:py-12 bg-gray-50">
            <div className="mobile-container">
              ...
              <div className="mt-8 sm:mt-10">
                  <div className="mobile-responsive-spacing md:space-y-0 md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-16">
                  {features.map((feature, index) => (
                    <motion.div 
                      key={feature.name} 
                        className="relative group h-full border-2 border-gray-200 rounded-xl p-6 bg-white/90 backdrop-blur-sm shadow-lg hover:border-blue-300 transition-all duration-300"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
      ...
      <div className="bg-white">
        <div className="mobile-container py-8 sm:py-12 lg:py-16 lg:flex lg:items-center lg:justify-between">
          <h2 className="mobile-heading font-bold tracking-tight text-gray-900">
              <span className="block mb-2">Ready to find your next opportunity?</span>
