  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 relative pt-20">
      ...
      >
        ...
        <h1 className="text-4xl font-extrabold text-blue-700 mb-4 text-center">Resources</h1>
        <p className="text-lg text-gray-700 mb-6 text-center">
          We're building our resources library!<br />
          Stay tuned for helpful guides and tools.
        </p>
