...
export default function PublicProfile({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white pt-24 overflow-hidden">
      {/* Full-screen blue-violet gradient background */}
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-blue-400 to-violet-400"></div>
          ...
          >
            ...
            {profileData.extracurriculars && (
              <div className="mb-8">
                ...
                <p className="text-gray-700">{profileData.extracurriculars}</p>
              </div>
            )}
            ...
            {profileData.careerInterests && (
              <div className="mb-8">
                ...
                <p className="text-gray-700">{profileData.careerInterests}</p>
              </div>
            )}
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center text-gray-700 relative">
                      ...
                      {isPremium ? (
                        ...
                        <span className="relative flex items-center">
                          <span className="select-none pointer-events-none blur-sm bg-gray-200 rounded px-2 py-1 text-gray-400" style={{ userSelect: 'none' }}>
                  ...
                  {profileData.email && (
                    <div className="flex items-center text-gray-700 relative">
                      ...
                      {isPremium ? (
                        <span>
                          <a href={`mailto:${profileData.email}`} className="text-blue-600 hover:text-blue-800 hover:underline">{profileData.email}</a>
                        </span>
                      ) : (
                        <span className="relative flex items-center">
                          <span className="select-none pointer-events-none blur-sm bg-gray-200 rounded px-2 py-1 text-gray-400" style={{ userSelect: 'none' }}>
            ...
            {showPremiumModal && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full relative flex flex-col items-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Unlock Contact Info</h3>
                  <p className="text-gray-500 mb-6 text-center">Make smarter decisions and increase your chances of success by unlocking direct contact details.</p>
                  <button
