  ...
  useEffect(() => {
    const checkAdminAndLoad = async () => {
      ...
      try {
        ...
        // Load article
        const articleResponse = await fetch(`/api/hs-news/${params.id}`);
        ...
        if (article.headline_image_url) {
          setImagePreview(article.headline_image_url);
        }
      } catch (err) {
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={() => router.push(`/hs-news/${params.id}`)}
