    ...
    <>
      ...
      <div className="absolute inset-0 overflow-hidden z-0 dark:hidden">
        <motion.div
          ...
          className="absolute -top-60 -right-60 w-[600px] h-[600px] bg-purple-200 rounded-full filter blur-xl animate-blob"
        />
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 0.5 }}
          transition={{ duration: 1.5, delay: 0.2, ease: "easeOut" }}
          className="absolute -bottom-60 -left-60 w-[600px] h-[600px] bg-indigo-200 rounded-full filter blur-xl animate-blob animation-delay-2000"
        />
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 0.5 }}
          transition={{ duration: 1.5, delay: 0.4, ease: "easeOut" }}
          className="absolute top-60 left-60 w-[600px] h-[600px] bg-violet-200 rounded-full filter blur-xl animate-blob animation-delay-4000"
        />
      </div>
